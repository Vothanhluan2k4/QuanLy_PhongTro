...
namespace QuanLy_PhongTro.Migrations
{
    ...
    [Migration("20250629090045_upTinTuc1")]
    partial class upTinTuc1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuanLy_PhongTro.Models.AccountPaidModel", b =>
                {
            ...
            modelBuilder.Entity("QuanLy_PhongTro.Models.LoaiTinTucModel", b =>
                {
                    b.Property<int>("MaLoaiTinTuc")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MaLoaiTinTuc"));

                    b.Property<string>("TenLoaiTinTuc")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.HasKey("MaLoaiTinTuc");
            ...
            modelBuilder.Entity("QuanLy_PhongTro.Models.MomoModel", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("MomoId"));
            ...
            modelBuilder.Entity("QuanLy_PhongTro.Models.SuCoModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QuanLy_PhongTro.Models.TinTucModel", b =>
                {
            ...
            modelBuilder.Entity("QuanLy_PhongTro.Models.VnpayModel", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("VnpayId"));
            ...
            modelBuilder.Entity("QuanLy_PhongTro.Models.AccountPaidModel", b =>
                {
                    b.HasOne("QuanLy_PhongTro.Models.HoaDonModel", "HoaDon")
                        .WithMany("AccountPaid")
            ...
            modelBuilder.Entity("QuanLy_PhongTro.Models.SuCoModel", b =>
                {
                    b.HasOne("QuanLy_PhongTro.Models.NguoiDungModel", "NguoiBaoCao")
                        .WithMany()
                        .HasForeignKey("MaNguoiDung")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("QuanLy_PhongTro.Models.PhongTroModel", "Phong")
                        .WithMany()
                        .HasForeignKey("MaPhong")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("QuanLy_PhongTro.Models.TinTucModel", b =>
                {
                    b.HasOne("QuanLy_PhongTro.Models.LoaiTinTucModel", "LoaiTinTuc")
                        .WithMany("TinTucs")
                        .HasForeignKey("MaLoaiTinTuc")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
